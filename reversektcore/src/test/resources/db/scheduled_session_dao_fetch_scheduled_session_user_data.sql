...
INSERT INTO video_details (VIDEO_NAME,VIDEO_DETAILS,CREATED_BY,UPDATED_BY,CREATED_DATE,UPDATED_DATE,STATUS) VALUES ('learning','learning video details',0,0,null,null,'A');
...
INSERT INTO scheduled_session (PROJECT_ITEM_SEQ,VIDEO_DETAIL_SEQ,SESSION_START_DATE_TIME,SESSION_END_DATE_TIME,CREATED_BY,UPDATED_BY,CREATED_DATE,UPDATED_DATE,STATUS)
VALUES (1,2,null,null,0,0,null,null,'A');
INSERT INTO scheduled_session_user (SCHEDULED_SESSION_SEQ,USER_PROFILE_SEQ,CREATED_BY,UPDATED_BY,CREATED_DATE,UPDATED_DATE,STATUS)
VALUES (1,1,0,0,null,null,'A');
INSERT INTO scheduled_session_user (SCHEDULED_SESSION_SEQ,USER_PROFILE_SEQ,CREATED_BY,UPDATED_BY,CREATED_DATE,UPDATED_DATE,STATUS)
VALUES (2,1,0,0,null,null,'A');